...
// DeleteResPlanDemand delete res plan demand
func (svc *service) DeleteResPlanDemand(cts *rest.Contexts) (interface{}, error) {
	...
	if err != nil {
		logs.Errorf("delete resource plan demand failed, err: %v, rid: %s", err, cts.Kit.Rid)
		return nil, err
	}
