...
func (svc *cvmSvc) ListTCloudZiyanInstanceConfig(cts *rest.Contexts) (interface{}, error) {
	...
	return svc.listTCloudZiyanInstanceConfig(cts, req, constant.UnassignedBiz, handler.ResOperateAuth)
}

// ListTCloudZiyanBizInstanceConfig ...
func (svc *cvmSvc) ListTCloudZiyanBizInstanceConfig(cts *rest.Contexts) (interface{}, error) {
	...
	return svc.listTCloudZiyanInstanceConfig(cts, req, bizID, handler.BizOperateAuth)
}

func (svc *cvmSvc) listTCloudZiyanInstanceConfig(cts *rest.Contexts, req *protocvm.TCloudInstanceConfigListOption,
	...
	if err != nil {
		logs.Errorf("validate tcloud-ziyan instance config failed, bizID: %d, err: %+v, rid: %s",
