...
// NewConf new redis connect config
func NewConf(redisConf *cc.Redis) (*Config, error) {
	return &Config{
		Address:          redisConf.Host,
		Password:         redisConf.Pwd,
		Database:         redisConf.Database,
		MasterName:       redisConf.MasterName,
		SentinelPassword: redisConf.SentinelPwd,
		MaxOpenConns:     redisConf.MaxOpenConns,
	}, nil
}
