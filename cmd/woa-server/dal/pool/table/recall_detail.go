...
type RecallDetail struct {
	...
	ClearCheckBizID string            `json:"clear_check_biz_id" bson:"clear_check_biz_id"`
	...
	InitializeBizID string            `json:"initialize_biz_id" bson:"initialize_biz_id"`
	...
	DataDeleteBizID string            `json:"data_delete_biz_id" bson:"data_delete_biz_id"`
	...
	ConfCheckBizID  string            `json:"conf_check_biz_id" bson:"conf_check_biz_id"`
