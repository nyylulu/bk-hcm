...
// Package dispatcher defines the dispatcher of the recycle task
package dispatcher
...
type TransitFailedState struct{}

// Name return the name of transit failed state
func (ts *TransitFailedState) Name() table.RecycleStatus {
	return table.RecycleStatusTransitFailed
}
