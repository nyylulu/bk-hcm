...
func (d *pmDevice) FindManyDevice(ctx context.Context, page metadata.BasePage, filter map[string]interface{}) (
	[]*types.PmDeviceInfo, error) {
	...
	insts := make([]*types.PmDeviceInfo, 0)
