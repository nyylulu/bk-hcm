...
import (
	...
	"hcm/cmd/woa-server/common/universalsql"
)

func parseConditionFromMapStr(inputCond *mongoCondition, inputKey string, inputCondMapStr mapstr.MapStr) (
	outputCond *mongoCondition, err error) {
