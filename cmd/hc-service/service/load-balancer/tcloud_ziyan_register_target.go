...
// RegisterZiyanTargetToListenerRule 批量到云上注册RS, 对接adaptor, 无db操作
func (svc *clbSvc) RegisterZiyanTargetToListenerRule(cts *rest.Contexts) (any, error) {
	...
	adpt, err := svc.ad.TCloudZiyan(cts.Kit, lb.AccountID)
	if err != nil {
		return nil, err
	}
