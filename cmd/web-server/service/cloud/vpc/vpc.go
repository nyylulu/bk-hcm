...
func (svc *service) ListVpcWithSubnetCountInBiz(cts *rest.Contexts) (interface{}, error) {
	...
	case enumor.Ziyan:
		return svc.listTCloudZiyanVpcWithSubnetCountInBiz(cts, bizID, listVpcReq, req.Zone)
	default:
...
func (svc *service) ListVpcWithSubnetCountInRes(cts *rest.Contexts) (interface{}, error) {
	...
	case enumor.Ziyan:
		return svc.listTCloudZiyanVpcWithSubnetCountInRes(cts, listVpcReq, req.Zone)
	default:
		return nil, errf.Newf(errf.InvalidParameter, "vendor: %s not support", vendor)
	}
}
...
// listTCloudZiyanVpcWithSubnetCountInBiz 查询自研云VPC列表和子网数量
func (svc *service) listTCloudZiyanVpcWithSubnetCountInBiz(cts *rest.Contexts, bizID int64, listVpcReq *core.ListReq,
	zone string) (interface{}, error) {
...
// listTCloudZiyanVpcWithSubnetCountInRes 查询自研云VPC列表和子网数量（资源级别）
func (svc *service) listTCloudZiyanVpcWithSubnetCountInRes(cts *rest.Contexts, listVpcReq *core.ListReq,
	zone string) (interface{}, error) {
