...
const inColumns: any = computed(() => ([
  ...
  },
  {
    ...
    isShow: !([VendorEnum.ZIYAN].includes(route.query.vendor) && whereAmI.value === Senarios.resource),
  },
    ...
    <bk-loading :loading="state.isLoading">
      <section class="rule-main">
        ...
        <div @click="showAuthDialog(actionName)">
          <bk-button v-show="!([VendorEnum.ZIYAN].includes(route.query.vendor) && whereAmI === Senarios.resource)"
