...
export const ZiyanRecord = (): Ext<ZiyanSecurityGroupRule> => ({
  protocol: '',
  port: '',
  cloud_service_id: '',
...
export enum ZiyanSourceAddressType {
...
export const ZiyanSourceTypeArr = [
  ZiyanSourceAddressType.IPV4,
  ZiyanSourceAddressType.IPV6,
  ZiyanSourceAddressType.SECURITY_GROUP,
  ZiyanSourceAddressType.TEMPLATE_IP,
  ZiyanSourceAddressType.TEMPLATE_IP_GROUP,
];

export enum ZiyanTemplatePort {
  Port = 'cloud_service_id', // 参数模板-端口
  Port_Group = 'cloud_service_group_id', // 参数模板-端口组
}

export const ZiyanTemplatePortArr = [ZiyanTemplatePort.Port, ZiyanTemplatePort.Port_Group];

export const ziyanTitles: (type: SecurityRuleType) => IHead[] = (type) => [
  {
    width: 450,
    minWidth: 120,
...
export const ziyanSourceAddressTypes = [
...
export const ziyanStrategys = [
  { value: 'ACCEPT', label: '允许' },
  { value: 'DROP', label: '拒绝' },
];

export const ZiyanRenderRow = defineComponent({
  props: {
    ...
    value: Object as PropType<ZiyanSecurityGroupRule>,
  ...
  setup(props, { expose, emit }) {
    ...
    const handleChange = (val: ZiyanSecurityGroupRule) => {
      emit('change', val);
    };
      ...
      <>
        <tr>
          ...
          <td>
            {
              // 参数模板-端口
              formModel.protocol === ZiyanTemplatePort.Port && (
                <SelectColumn
                  ref={portRef}
            ...
            {
              // 参数模板-端口组
              formModel.protocol === ZiyanTemplatePort.Port_Group && (
                <SelectColumn
                  ref={portRef}
            ...
            {
              // 协议
              ![ZiyanTemplatePort.Port, ZiyanTemplatePort.Port_Group].includes(formModel.protocol) && (
                <InputColumn
