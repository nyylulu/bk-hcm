...
const fetchChartData = async () => {
  const res = await http.post('/api/v1/woa/task/apply/findmany/bizs/hosts/statistics', {
...
<template>
  <div class="chart-apply-host-top" ref="chartRef"></div>
</template>

<style lang="scss" scoped>
.chart-apply-host-top {
  width: 100%;
  height: 100%;
}
</style>
