...
import { TaskClbType, TaskCvmType, TaskStatus, TaskSource } from '@/views/task/typings';
import { TASK_CLB_TYPE_NAME, TASK_CVM_TYPE_NAME, TASK_SOURCE_NAME, TASK_STATUS_NAME } from '@/views/task/constants';
...
@Model('task/search-cvm.view')
export class SearchCvmView extends SearchView {
  @Column('enum', { name: '任务类型', index: 1, option: TASK_CVM_TYPE_NAME, op: QueryRuleOPEnum.JSON_OVERLAPS })
  operations: TaskCvmType;
}
