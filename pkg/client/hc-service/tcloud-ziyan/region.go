...
// Sync sync zone.
func (cli *RegionClient) Sync(kt *kit.Kit, request *region.TCloudRegionSyncReq) error {
	return common.RequestNoResp[region.TCloudRegionSyncReq](cli.client, rest.POST, kt, request, "/regions/sync")
}
