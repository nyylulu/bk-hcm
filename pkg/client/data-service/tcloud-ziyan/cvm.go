...
func (cli *CvmClient) BatchCreateCvm(ctx context.Context, h http.Header,
	request *protocloud.CvmBatchCreateReq[corecvm.TCloudZiyanHostExtension]) (*core.BatchCreateResult, error) {
...
func (cli *CvmClient) BatchUpdateCvm(ctx context.Context, h http.Header,
	request *protocloud.CvmBatchUpdateReq[corecvm.TCloudZiyanHostExtension]) error {
...
func (cli *CvmClient) GetCvm(ctx context.Context, h http.Header, id string) (
	*corecvm.Cvm[corecvm.TCloudZiyanHostExtension], error) {
	...
	resp := new(protocloud.CvmGetResp[corecvm.TCloudZiyanHostExtension])
...
func (cli *CvmClient) ListCvmExt(ctx context.Context, h http.Header, request *protocloud.CvmListReq) (
	*protocloud.CvmExtListResult[corecvm.TCloudZiyanHostExtension], error) {

	resp := new(protocloud.CvmExtListResp[corecvm.TCloudZiyanHostExtension])
