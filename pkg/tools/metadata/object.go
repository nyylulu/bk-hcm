...
func GetInstIDFieldByObjID(objID string) string {
	...
	case pkg.BKInnerObjIDApp:
		return pkg.BKAppIDField
	case pkg.BKInnerObjIDSet:
		return pkg.BKSetIDField
	case pkg.BKInnerObjIDModule:
		return pkg.BKModuleIDField
	case pkg.BKInnerObjIDObject:
		return pkg.BKInstIDField
	case pkg.BKInnerObjIDHost:
		return pkg.BKHostIDField
	case pkg.BKInnerObjIDProc:
		return pkg.BKProcIDField
	case pkg.BKInnerObjIDPlat:
		return pkg.BKCloudIDField
	default:
		return pkg.BKInstIDField
	}
...
func GetInstNameFieldName(objID string) string {
	switch objID {
	case pkg.BKInnerObjIDApp:
		return pkg.BKAppNameField
	case pkg.BKInnerObjIDSet:
		return pkg.BKSetNameField
	case pkg.BKInnerObjIDModule:
		return pkg.BKModuleNameField
	case pkg.BKInnerObjIDHost:
		return pkg.BKHostInnerIPField
	case pkg.BKInnerObjIDProc:
		return pkg.BKProcNameField
	case pkg.BKInnerObjIDPlat:
		return pkg.BKCloudNameField
	default:
		return pkg.BKInstNameField
	}
}
