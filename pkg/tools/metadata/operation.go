...
var (
	...
	BizModuleHostChart = ChartConfig{
		ReportType: pkg.BizModuleHostChart,
	}

	// HostOsChart host os chart
	HostOsChart = ChartConfig{
		ReportType: pkg.HostOSChart,
		Name:       "按操作系统类型统计",
		ObjID:      "host",
		Width:      "50",
		ChartType:  "pie",
	...
	HostChangeBizChart = ChartConfig{
		ReportType: pkg.HostChangeBizChart,
		Name:       "主机数量变化趋势",
		Width:      "100",
		XAxisCount: 20,
	}
	...
	ModelAndInstCountChart = ChartConfig{
		ReportType: pkg.ModelAndInstCount,
	}

	// ModelInstChart model inst chart
	ModelInstChart = ChartConfig{
		ReportType: pkg.ModelInstChart,
		Name:       "实例数量统计",
		Width:      "50",
		ChartType:  "bar",
		XAxisCount: 10,
	...
	ModelInstChangeChart = ChartConfig{
		ReportType: pkg.ModelInstChangeChart,
		Name:       "实例变更统计",
		Width:      "50",
		ChartType:  "bar",
		XAxisCount: 10,
	...
	InnerChartsMap = map[string]ChartConfig{
		pkg.BizModuleHostChart:   BizModuleHostChart,
		pkg.ModelAndInstCount:    ModelAndInstCountChart,
		pkg.HostOSChart:          HostOsChart,
		pkg.HostBizChart:         HostBizChart,
		pkg.HostCloudChart:       HostCloudChart,
		pkg.HostChangeBizChart:   HostChangeBizChart,
		pkg.ModelInstChart:       ModelInstChart,
		pkg.ModelInstChangeChart: ModelInstChangeChart,
	}

	// InnerChartsArr inner charts array
	InnerChartsArr = []string{
		pkg.BizModuleHostChart,
		pkg.ModelAndInstCount,
		pkg.HostOSChart,
		pkg.HostBizChart,
		pkg.HostCloudChart,
		pkg.HostChangeBizChart,
		pkg.ModelInstChart,
		pkg.ModelInstChangeChart,
	}
)
