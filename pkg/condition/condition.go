...
type Condition interface {
	SetPage(page mapstr.MapStr) error
...
func (cli *condition) SetPage(page mapstr.MapStr) error {
...
func (cli *condition) Parse(data mapstr.MapStr) error {
...
func (cli *condition) ToMapStr() mapstr.MapStr {
	tmpResult := mapstr.MapStr{}
