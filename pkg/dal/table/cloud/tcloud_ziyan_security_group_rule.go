...
// TCloudZiyanSGRuleColumns defines all the tcloud security group rule table's columns.
var TCloudZiyanSGRuleColumns = utils.MergeColumns(nil, TCloudZiyanSGRuleColumnDescriptor)

// TCloudZiyanSGRuleColumnDescriptor is TCloud Security Group Rule's column descriptors.
var TCloudZiyanSGRuleColumnDescriptor = utils.ColumnDescriptors{
...
// TCloudZiyanSecurityGroupRuleTable define tcloud security group rule table.
type TCloudZiyanSecurityGroupRuleTable struct {
...
// TableName return tcloud ziyan security group rule table name.
func (t TCloudZiyanSecurityGroupRuleTable) TableName() table.Name {
	return table.TCloudZiyanSecurityGroupRuleTable
}

// InsertValidate tcloud ziyan security group rule table when inserted.
func (t TCloudZiyanSecurityGroupRuleTable) InsertValidate() error {
	// length validate.
...
// UpdateValidate tcloud ziyan security group rule table when updated.
func (t TCloudZiyanSecurityGroupRuleTable) UpdateValidate() error {
	// length validate.
	if err := validator.Validate.Struct(t); err != nil {
		return err
	}
