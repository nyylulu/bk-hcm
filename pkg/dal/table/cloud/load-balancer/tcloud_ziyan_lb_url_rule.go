...
// TCloudZiyanLbUrlRuleTable 腾讯云负载均衡四层/七层规则表
type TCloudZiyanLbUrlRuleTable struct {
...
func (tlbur TCloudZiyanLbUrlRuleTable) TableName() table.Name {
	return table.TCloudZiyanLbUrlRuleTable
}

// InsertValidate tcloud_lb_url_rule table when insert.
func (tlbur TCloudZiyanLbUrlRuleTable) InsertValidate() error {
...
func (tlbur TCloudZiyanLbUrlRuleTable) UpdateValidate() error {
	if err := validator.Validate.Struct(tlbur); err != nil {
		return err
	}
