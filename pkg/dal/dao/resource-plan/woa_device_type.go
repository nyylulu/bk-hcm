...
type WoaDeviceTypeInterface interface {
	...
	List(kt *kit.Kit, opt *types.ListOption) (*rtypes.WoaDeviceTypeListResult, error)
...
func (d WoaDeviceTypeDao) List(kt *kit.Kit, opt *types.ListOption) (*rtypes.WoaDeviceTypeListResult, error) {
	if opt == nil {
	...
	if opt.Page.Count {
		...
		return &rtypes.WoaDeviceTypeListResult{Count: count}, nil
	}
	...
	return &rtypes.WoaDeviceTypeListResult{Count: 0, Details: details}, nil
}
