...
(
    ...
    yearMonth                                    int,
    bill_payer_account_id                        longtext,
    line_item_usage_account_id                   longtext,
    bill_invoice_id                              longtext,
    bill_billing_entity                          longtext,
    line_item_product_code                       longtext,
    product_product_family                       longtext,
    product_product_name                         longtext,
    line_item_usage_type                         longtext,
    product_instance_type                        longtext,
    product_region                               longtext,
    product_location                             longtext,
    line_item_resource_id                        longtext,
    pricing_term                                 longtext,
    line_item_line_item_type                     longtext,
    line_item_line_item_description              longtext,
    line_item_usage_start_date                   longtext,
    line_item_usage_end_date                     longtext,
    line_item_usage_amount                       longtext,
    pricing_unit                                 longtext,
    pricing_public_on_demand_rate                longtext,
    line_item_unblended_rate                     longtext,
    line_item_net_unblended_rate                 longtext,
    savings_plan_savings_plan_rate               longtext,
    pricing_public_on_demand_cost                longtext,
    line_item_unblended_cost                     longtext,
    line_item_net_unblended_cost                 longtext,
    savings_plan_savings_plan_effective_cost     longtext,
    savings_plan_savings_plan_net_effective_cost longtext,
    reservation_effective_cost                   longtext,
    reservation_net_effective_cost               longtext,
    line_item_currency_code                      longtext,
    line_item_operation                          longtext,
    rate                                         double,
    cost                                         decimal(38, 10),
    productid                                    int,
    linked_accountname                           longtext,
    region                                       int,
